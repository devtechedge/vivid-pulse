                                  ...
                                  {preview.isCodeAsset && preview.codeSample && (
                                    <div className="mt-1 bg-slate-900/50 p-2 rounded border border-slate-900 flex flex-col gap-1">
                                      ...
                                      <button
                                        ...
                                        className="mt-1 py-1 w-full text-center bg-violet-600/10 hover:bg-violet-600 border border-violet-500/20 text-violet-300 hover:text-white text-[9px] font-bold uppercase rounded cursor-pointer transition-all"
                                      >
